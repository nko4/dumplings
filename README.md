...
~~~sh
# getting the code
git clone git@github.com:nko4/dumplings.git && cd ./dumplings/

# developing
npm install
npm start

# deploying (to http://dumplings.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@dumplings.2013.nodeknockout.com
ssh root@dumplings.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@dumplings.2013.nodeknockout.com
ssh -i ./id_deploy root@dumplings.2013.nodeknockout.com
~~~
